...
class OLD_ComponentController extends AbstractController
{
    private $ccserv;
    private $fdserv;
    ...
    public function change(Request $request, string $path = null) {
      ...
      if(!is_null($comp)){
        ...
        return $this->render('component_change/component_change.html.twig', [
    ...
    /**
     * @Route("/component/delete_old/{path}", name="component_delete_old")
     */
